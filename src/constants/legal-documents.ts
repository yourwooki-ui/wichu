...
export const LEGAL_DOCUMENTS: Record<string, LegalDocument> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        title: '위치 정보',
        body: '프로필 간 거리 표시를 위해 앱 사용 중 위치를 수집합니다. 원본 좌표는 다른 이용자에게 공개하지 않으며 거리 값으로만 변환해 표시합니다. 위치 수집은 기기 설정에서 언제든 중단할 수 있고, 중단하면 거리 표시만 제한됩니다. [확정 필요: 위치정보 보유 기간과 위치기반서비스 사업자 신고 여부]',
      },
      {
        title: '이용 목적',
      ...
      {
        title: '공개 범위',
        body: '정확한 생년월일과 원본 위치 좌표는 다른 이용자에게 공개하지 않습니다. 프로필에는 나이, 국가, 대략적인 거리와 이용자가 공개하기로 선택한 항목만 표시합니다. 메시지는 매치된 상대에게만 전달됩니다.',
      },
      {
        title: '보유 기간과 파기',
