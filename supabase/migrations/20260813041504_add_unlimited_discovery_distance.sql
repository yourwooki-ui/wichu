...
drop constraint if exists user_settings_max_distance_km_check;

alter table public.user_settings
alter column max_distance_km set default 0;

update public.user_settings
set max_distance_km = 0
where max_distance_km = 16000;

alter table public.user_settings
add constraint user_settings_max_distance_km_check
check (max_distance_km = 0 or max_distance_km between 1 and 16000);
