...
create or replace function public.get_my_incoming_likes(p_limit integer default 50)
returns table (
  profile_id uuid,
...
grant execute on function public.get_my_incoming_likes(integer) to service_role;
